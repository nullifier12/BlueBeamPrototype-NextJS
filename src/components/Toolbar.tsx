...
const tools: Tool[] = [
  ...
  { id: 'highlight', name: 'Highlight', icon: 'highlighter', type: 'highlight', shortcut: 'H', isActive: false },
  { id: 'text', name: 'Text', icon: 'type', type: 'text', shortcut: 'T', isActive: false },
  { id: 'sticky-note', name: 'Sticky Note', icon: 'sticky-note', type: 'sticky-note', shortcut: 'S', isActive: false },
  { id: 'rectangle', name: 'Rectangle', icon: 'square', type: 'rectangle', shortcut: 'R', isActive: false },
  { id: 'circle', name: 'Circle', icon: 'circle', type: 'circle', shortcut: 'C', isActive: false },
  { id: 'ellipse', name: 'Ellipse', icon: 'ellipse', type: 'ellipse', shortcut: 'E', isActive: false },
  { id: 'line', name: 'Line', icon: 'minus', type: 'line', shortcut: 'L', isActive: false },
  ...
  return (
    <div className="toolbar">
      ...
      <div className="flex gap-1">
        <button className="toolbar-button" onClick={onUpload} title="Upload Document">
          <Upload size={16} />
        </button>
        ...
        <button className="toolbar-button" onClick={onExport} title="Export JSON">
          <FileDown size={16} />
        </button>
        <button className="toolbar-button" onClick={onImport} title="Import JSON">
          <FileUp size={16} />
        </button>
      </div>
      ...
      {/* Edit Operations */}
      <div className="flex gap-1">
        <button className="toolbar-button" onClick={onUndo} title="Undo (Ctrl+Z)">
          <Undo size={16} />
        </button>
        <button className="toolbar-button" onClick={onRedo} title="Redo (Ctrl+Y)">
          <Redo size={16} />
        </button>
      </div>
