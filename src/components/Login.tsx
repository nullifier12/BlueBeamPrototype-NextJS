  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!data.projectId && projectId?.trim()) {
        console.warn("⚠️ Project ID was provided but not returned. User may not have access to this project.");
        setError("You don't have access to this project. Please check the Project ID or contact your administrator.");
        setLoading(false);
        return;
      }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="w-full max-w-md p-8 bg-card border border-border rounded-lg shadow-lg">
        ...
        <h1 className="text-2xl font-bold text-center mb-6">BlueBeam Prototype</h1>
