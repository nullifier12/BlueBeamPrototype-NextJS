...
-- Annotation Type Adjustments table
-- Stores default settings and adjustments for each annotation type
...
-- Insert default annotation type adjustments (project_id NULL means global defaults)
